...
| **EMA-89**            | Long-term Trend | Period: 165                 | Major trend filter (higher timeframe bias)         | Price above EMA-165 = strong uptrend bias; pullbacks to EMA-165 often high-probability entries      | ATR expansion on touches                                 | Strong Momentum, Trending Pullback  |
