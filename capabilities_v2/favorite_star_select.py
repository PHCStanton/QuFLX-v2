...
try:
    ...
    # Allow running as a script: python capabilities_v2\favorite_star_select.py
    import sys
...
if __name__ == "__main__":
    ...
    if ctx is None:
        try:
            ...
            print("[OK] Attached to Chrome session:", getattr(driver, "current_url", "unknown"), file=sys.stderr)
        except Exception as e:
            print(f"[ERROR] Failed to attach to Chrome session: {e}", file=sys.stderr)
            raise SystemExit(1)
